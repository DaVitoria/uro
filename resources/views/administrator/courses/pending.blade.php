<x-layouts.dashboard>
    <div class="d-flex pt-4">
        <nav id="breadcrumbs" class="mb-3">
            <ul>
                ...
                <li><a href="#"> On review courses </a></li>
            </ul>
        </nav>
    </div>
    ...
    <div class="section-header pb-0">
        <div class="section-header-left">
            <h4> On review courses ({{ $courses->total() }})</h4>
        </div>
                    ...
                    <a href="course-intro.html">
                        <div class="course-card">
                            ...
                            <div class="d-flex justify-content-between px-4 py-2">
                                ...
                                <form action="{{ route('administrator.courses.reject', ['course' => $course->id]) }}"
                                    method="POST">
                                    @csrf
                                    <button type="submit" class="btn btn-icon btn-hover btn-danger" uk-tooltip="Reject"
                                        title="" aria-expanded="false">
                                        <i class="icon-line-awesome-close"></i> </button>
                                </form>
                            </div>
