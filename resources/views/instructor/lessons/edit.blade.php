<x-layouts.dashboard>
    ...
    <div class="uk-card uk-card-default uk-card-small uk-card-body">
        <form class="p-4 pt-0"
            action="{{ route('instructor.courses.lessons.update', ['course' => $course->id, 'module' => $module, 'lesson' => $lesson]) }}"
            method="POST">
                ...
                <div class="uk-width-1-1">
                    ...
                    <div class="uk-form-group">
                        ...
                        <div class="uk-position-relative w-100">
                            ...
                            <textarea class="uk-input" name="description" required>{{ $lesson->description }}</textarea>
                        </div>
                    </div>
                    <div class="uk-form-group">
                        ...
                        <div class="uk-position-relative w-100">
                            ...
                            <input type="number" class="uk-input" name="lesson_number" required
                                value="{{ $lesson->lesson_number }}" min="1">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="uk-position-relative w-100">
                            <select name="video_platform" class="selectpicker">
                                @foreach ($video_platforms as $key => $platform)
                                    <option value="{{ $platform['id'] }}" @selected($platform['id'] === $lesson->video_platform->value)>
