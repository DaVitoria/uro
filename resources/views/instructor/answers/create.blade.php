<x-layouts.dashboard>
    ...
    <div class="uk-card uk-card-default uk-card-small uk-card-body">
        <form class="p-4 pt-0"
            action="{{ route('instructor.courses.answers.store', ['course' => $course->id, 'module' => $module->id, 'lesson' => $lesson->id, 'quiz' => $quiz, 'question' => $question]) }}"
            method="POST">
                ...
                <div class="uk-width-1-1">
                    <div class="uk-form-group">
                        ...
                        <div class="uk-position-relative w-100">
                            ...
                            <textarea name="content" id="" class="uk-textarea" required>{{ old('content') }}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="w-100">
                            <label for="is_correct"> <input type="checkbox" id="is_correct" name="is_correct"
                                    @checked(old('is_correct') ? true : false) style="display:inline;height:16px;width:16px">
                                Correta</label>
